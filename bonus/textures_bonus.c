...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/06 13:06:59 by ldufour           #+#    #+#             */
/*   Updated: 2023/11/06 13:06:59 by ldufour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	render_others_textures(t_game *game)
{
	...
	game->o.enemy_t = mlx_load_png("./assets/other/enemy.png");
	...
	game->o.enemy_i = mlx_texture_to_image(game->mlx, game->o.enemy_t);
	game->o.item_i = (mlx_image_t **)malloc(game->nb_collectible
			* sizeof(mlx_image_t *));
